...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\Users\\ex_wanghao29\\Desktop\\blog\\blog-offical-frontend\\prisma\\generated\\mysql",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "D:\\Users\\ex_wanghao29\\Desktop\\blog\\blog-offical-frontend\\prisma\\mysql\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../.env",
...
config.injectableEdgeEnv = () => ({
  parsed: {
    MYSQL_URI_BLOG: typeof globalThis !== 'undefined' && globalThis['MYSQL_URI_BLOG'] || typeof process !== 'undefined' && process.env && process.env.MYSQL_URI_BLOG || undefined
  }
})
